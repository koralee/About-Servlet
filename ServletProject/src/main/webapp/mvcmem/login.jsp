...
<body>
	<c:choose>
		...
		<c:otherwise>
			...
			<form action="member.mdo?cmd=loginProcess" method="post">
				<table width="300" border="1">
					<tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="submit" value="로그인">&nbsp;&nbsp; <input type="button" value="회원가입" onclick="javascript:window.location='?cmd=regForm'"></td>
					</tr>
				</table>
			</form>
		</c:otherwise>
